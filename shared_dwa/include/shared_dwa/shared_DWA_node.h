...
namespace shared_DWA
{
    ...
    private:
        ...
        float calDist2Collision(bool collided, float v_dw, float w_dw, std::vector<float> &min_dist2goal, std::vector<float> &angle2goal, std::vector<geometry_msgs::Point> &candidate_points);
