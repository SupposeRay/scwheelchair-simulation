...
namespace shared_DWA
{
    ...
    private:
        ...
        // callback for trajectory guidance
        void trajCallback(const nav_msgs::Path &msg_traj);
        // callback for time
        ...
        float calDist2Collision(float v_dw, float w_dw, float sample_interval, float sample_time);
        // collision check
        ...
        // guidance mode
        std::string guidance_mode = "joystick";
        // ros time
        ros::Time t_now;
        ...
        float x_agent = 0, y_agent = 0;
        // current orientation from odometry
        tf::Quaternion q_agent;
        ...
        // subgoal orientation
        tf::Quaternion subgoal_quat;
        // subgoal search starting point
